...
### Aktueller Stand
- **Nächste Seiten:** 421–440
- **Zuletzt gelesen:** 401–420
- **Achtung:** Gruppe C 10 ✅ SUS vollständig (10 Items, Skala 0–100, Benchmark 68, Werte-Skala, UMUX-Lite). Aufgabe 7 ✅ SUS vollständig ergänzt. Gruppe A 8 ✅ Prototyp–MVP vollständig. Gruppe B 2 ✅ MVP-Details (Pyramide, Analogie, Formal aus Folie 837) ergänzt. Gruppe B 9 ✅ Action Priority Matrix (Impact×Effort: MUST HAVES / LOW HANGING FRUITS / QUICK WINS / MONEY PITS) + Feature-Priorisierungsmatrix für MVP vollständig. Gruppe B 4 ✅ Usability-Test vollständig ergänzt (Teilnehmeranzahl, Onion Model, Rollen, Geführt/Ungeführt, 3 Phasen, 5 Schwere-Klassen, HE vs. UT Vergleich). Aufgabe 11 ✅ Stakeholder vs. User vollständig (ISO-Neuerung, Vergleichstabelle, Zielkonflikt). Noch offen: Gruppe C 8 (Euro-Dollar-Interface), Reliabilität & Validität (für spätere Verwendung).
