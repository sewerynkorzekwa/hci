...
### Aktueller Stand
- **Nächste Seiten:** — PDF vollständig gelesen (475/475 Seiten) ✅
- **Zuletzt gelesen:** 461–475
- **Achtung:** Aufgabe 4 ✅ Alle psychologischen Prinzipien ergänzt (Occam's Razor, Goal-Gradient Effect, Parkinson's Law, Pareto-Prinzip, Postel's Law, Doherty Threshold, TIME: Power of 10). PDF-Lektüre abgeschlossen.

---

## Iterationslog

### Iteration 24 — Seiten 461–475 (Folien ~921–949) — LETZTE ITERATION
**Inhalt:** Abschluss Psychologische Prinzipien mit vollständigen Origins & Takeaways: Law of Uniform Connectedness (Takeaways: group functions via colors/lines/frames, tangible connecting references; Origins: Gestalt laws 5 Kategorien: Proximity/Similarity/Continuity/Closure/Connectedness). Miller's Law (Takeaways: nicht "magical number seven" zur Rechtfertigung von Einschränkungen nutzen; Ursprung: George Miller 1956, 7 Chunks ± 2). Serial Position Effect (Herman Ebbinghaus; Primacy + Recency; Apple/EA/Nike; least important items in middle; key actions far left/right). Von Restorff Effect (Hedwig von Restorff 1906–1962, 1933 Studie; Isolation Effect; make important info visually distinctive; restraint when placing emphasis). Zeigarnik Effect (Bluma Wulfovna Zeigarnik 1900–1988; Berlin School + Vygotsky Circle; Lewin Memorial Award 1983; invite content discovery + provide artificial progress). **NEU: Occam's Razor** (William of Ockham c.1287–1347; lex parsimoniae; avoid complexity from start; remove elements until no more can be removed). **NEU: Goal-Gradient Effect** (Clark Hull 1932; Ratten liefen schneller je näher das Futter; artificial progress motivates completion). Fitts's Law (Paul Fitts 1954; speed-accuracy trade-off; touch targets large+spacing+easy-to-acquire). Hick's Law (Hick & Hyman 1952; 5 Takeaways inkl. progressive onboarding + not to simplify to abstraction). **NEU: Parkinson's Law** (Cyril Northcote Parkinson, The Economist 1955; task inflates to fill time; limit task duration to expected time). Peak-End Rule (Kahneman 1993; 14°C Wasser-Studie; people recall negative experiences more vividly; design the "end" of user journey). **NEU: Pareto-Prinzip** (Vilfredo Pareto; 80/20; 80% land by 20% population; focus effort on features with largest benefit to most users). **NEU: Postel's Law** (Jon Postel; TCP Robustness Principle; be liberal in what you accept, conservative in what you send). **NEU: Doherty Threshold** (Doherty & Thadani 1982, IBM Systems Journal; <400ms response; productivity soars; progress bars + animation + perceived delay). **NEU: TIME Power of 10** (Nielsen 2009; 0,1s/1s/10s Grenzen). **NEU: Cheating the Perception of Time** (pulsende Progress Bars schneller wahrgenommen).

**Beantwortete/ergänzte Fragen:**
- Aufgabe 4: Psychologische Prinzipien ✅ vollständig (Occam's Razor, Goal-Gradient Effect, Parkinson's Law, Pareto-Prinzip, Postel's Law, Doherty Threshold, TIME Power of 10, Cheating Perception of Time)
...
**Beantwortete/ergänzte Fragen:**
- Gruppe B, 9: Priorisierungsmatrix ✅ Lucky Noodle Berechnungsbeispiel ergänzt
- Gruppe B, 11: Phasen + Artefakte ✅ CUXD vollständig (Artefaktliste, Basis, ITERATION≠DESIGN, Lean UX, Agile)
- Aufgabe 8: UX Workshop Ablauf ✅ 9 Workshop-Prinzipien ergänzt

### Iteration 21 — Seiten 401–420 (Folien ~801–840)
**Inhalt:** Usability-Test Teilnehmeranzahl (Folie 801): 5 Probanden → 85% der Probleme; ab 6. Proband Lerneffekt; Nielsen: 3 iterative Testings à 5 TN. Onion Model (Folie 802): Probleme verdecken sich gegenseitig → mehrmals testen. Zeitplan (Folie 804): 30–45 Min pro Session, 15 Min Puffer. Rollen & Setup (Folie 805): Proband/Moderator/Note Taker. Geführter vs. Ungeführter Test (Folie 808): Moderiert = günstig + befragbar; Unmoderiert = teuer + keine Hilfestellung. Usability-Test 3 Phasen (Folie 808): Vorbereitung / Durchführung / Auswertung. HE vs. UT Vergleich (Folie 810): HE = günstig, kein Ersatz für UT; UT = mehr Probleme, reale User, repräsentativ. Bewertung Usability-Probleme (Folien 811–812): 3 Fragen (kritische Aufgabe? schwer zu überwinden? persistent?) + 5 Schwere-Klassen (Schwerwiegend/Moderat/Geringfügig/Positiv/Beobachtung). Häufigkeit von Beobachtungen (Folie 813): Symbole statt Zahlen (KEINE:R bis ALLE). Quantitative Metriken / SUS (Folien 815–817): 10 Items, Skala 0–100, Benchmark 68, Skala (Sehr schlecht → Perfekt). UMUX-Lite (Folien 818–819): 2 Fragen, r=0,83 zum SUS, Usefulness + Usability. Evaluation Methods (Folie 820): Matrix formativ/summativ × qualitativ/quantitativ. Action Priority Matrix (Folie 822): Impact×Effort → MUST HAVES / LOW HANGING FRUITS / QUICK WINS / MONEY PITS. Reliabilität & Validität (Folien 824–828): 4 Kombinationen (Schießscheiben-Diagramm). Deliver-Phase (Folie 829): vollständiger UX-Prozess Überblick. MVP vollständig (Folien 830–839): Definition, Pyramide (Funktional→Bedeutungsvoll), CORE FEATURES DONE RIGHT, narrative-complete not feature-complete, Analogie Skateboard→Auto, MVP vs. MLP, Prototyp vs. MVP Vergleich formal. Priorisierungsmatrix für MVP (Folien 838–839): Businessziele × Kundennutzen × Aufwand → Gesamtpunkte.

**Beantwortete/ergänzte Fragen:**
- Gruppe A, 8: Prototyp–MVP ✅ vollständig (Definition, Pyramide, Analogie, MVP vs. Prototyp formal)
- Gruppe B, 2: Lo-Fi/Hi-Fi ✅ MVP-Details aus Folie 837 ergänzt
- Gruppe B, 4: Usability-Metriken ✅ vollständig (Teilnehmeranzahl, Onion Model, Rollen, geführt/ungeführt, 3 Phasen, 5 Schwere-Klassen, HE vs. UT, Action Priority Matrix)
- Gruppe B, 9: Priorisierungsmatrix ✅ vollständig (Action Priority Matrix Impact×Effort + Feature-Priorisierungsmatrix)
- Gruppe C, 10: SUS ✅ vollständig (10 Items, Skala, Benchmark 68, Werte-Skala, UMUX-Lite)
- Aufgabe 7: Usability-Metriken ✅ SUS vollständig ergänzt
- Aufgabe 11: Stakeholder vs. User ✅ vollständig (ISO-Neuerung, Vergleich, Zielkonflikte)
